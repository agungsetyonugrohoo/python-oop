class Hero :
    def __init__(self, name) :
        # membuat level dengan memiliki step kenaikan berdasarkan levelnya dari level 1 hingga level 5
    ...
    # membuat method untuk dapat di setting (override) dari luar (sub class)
    @property
